...
const EVENT_TYPES = ['qr_scan', 'partner_click', 'partner_page_view_from_hub', 'contact_submit', 'external_site_click'];
const QR_CODES = [
  'qr-office-001',
  'qr-office-002',
...
export function generateEvent(options = {}) {
  ...
  const referrerId = options.referrerId !== undefined ? options.referrerId : (Math.random() > 0.5 ? generateQRCode() : null);
