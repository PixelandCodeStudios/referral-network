...
async function main() {
  ...
  console.log(
    `   Mean difference: ${chalk.yellow("+" + (notifiable.mean - nonNotifiable.mean).toFixed(2) + "ms")} (${chalk.yellow("+" + meanOverhead.toFixed(1) + "%")})`
  );
  console.log(
    `   p95 difference:  ${chalk.yellow("+" + (notifiable.p95 - nonNotifiable.p95).toFixed(2) + "ms")} (${chalk.yellow("+" + p95Overhead.toFixed(1) + "%")})`
  );
  console.log("");
  ...
  console.log(
    `   Improvement:    ${chalk.green("-" + (notifiable.p95 - nonNotifiable.p95).toFixed(2) + "ms")} (${chalk.green("-" + p95Overhead.toFixed(1) + "%")})`
  );
  console.log("");
